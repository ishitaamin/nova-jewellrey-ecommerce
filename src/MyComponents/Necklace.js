...
const necklaceFilters = ["All", "Pendant", "Pearl", "Statement", "Initial", "Emerald"];

const Necklace = ({ onLike, likedProducts }) => {
  ...
  const filteredProducts = necklaceProducts.filter(
    (product) =>
  ...
  return (
    <div className="bracelet-page">
      ...
      <div className="slideshow-container">
        <img src={'/images/third.jpg'} alt="Necklace Collection" className="slideshow-image" />
      </div>
      ...
      <div className="filter-tab-container">
        {necklaceFilters.map((filter, index) => (
          <button
            key={index}
